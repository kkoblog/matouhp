      ...
      <header className="relative h-screen flex flex-col items-center justify-center">
        ...
        <div className="relative text-center text-white">
          ...
          <div className="space-x-8 text-base md:text-xl tracking-wider">
            <a href="#floral" className="hover:text-[#928e84]">
              Concept
            </a>
            <a href="#landscape" className="hover:text-[#928e84]">
              Staff
            </a>
            <a href="#cafe" className="hover:text-[#928e84]">
              Contact
            </a>
          </div>
        </div>
              ...
              <div key={idx} className="flex flex-col items-center bg-white p-6 rounded-lg shadow-md w-64">
                ...
                {staff.name === "天野 恵" && (
                  <div className="w-full mt-2 border-t border-[[#928e84] pt-4">
                    ...
                    <div className="text-[#4a4a4a] text-sm mb-2">育てる美髪。カット＋COTA シャンプー・トリートメント付き</div>
                    <div className="text-[#928e84] font-bold text-lg mb-2">¥13,300</div>
                ...
                {staff.name === "堀 綾希子" && (
                  <div className="w-full mt-2 border-t border-[[#928e84] pt-4">
                    ...
                    <div className="text-[#4a4a4a] text-sm mb-2">私を整える*カットケアコース</div>
                    <div className="text-[#928e84] font-bold text-lg mb-2">¥8,500</div>
                    <a 
                      href="https://beauty.hotpepper.jp/slnH000759489/coupon/" 
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                {staff.name === "石垣 加奈" && (
                  <div className="w-full mt-2 border-t border-[[#928e84] pt-4">
                    ...
                    <div className="text-[#4a4a4a] text-sm mb-2">髪にご褒美を* カット＋集中ケアトリートメント</div>
                    <div className="text-[#928e84] font-bold text-lg mb-2">¥10,900</div>
